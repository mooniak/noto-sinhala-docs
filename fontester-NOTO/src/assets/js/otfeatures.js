...
function refreshFeatures() {
	...
	// Apply the Code
	$('.otfeat').css("font-variant", fakeSC );
	$('.otfeat').css("font-feature-settings", codeCSS3 );
	$('.otfeat').css("-moz-font-feature-settings", codeCSS3 );
	$('.otfeat').css("-webkit-font-feature-settings", codeCSS3 );
	$('.otfeat').css("-ms-font-feature-settings", codeCSS3 );
	$('.otfeat').css("-o-font-feature-settings", codeCSS3 );
